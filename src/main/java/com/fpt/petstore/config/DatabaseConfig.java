...
/**
 * Classe responsável pela configuração do acesso ao banco de dados.
 *
 * Configura o DataSource (Fonte de Dados), o gerenciador de transações,
 * o EntityManagerFactory e outras configurações essenciais para o funcionamento
